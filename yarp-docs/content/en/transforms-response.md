...
title: Response & trailer transforms
lede: >-
  All response headers and trailers are copied from the proxied response to the outgoing client
sourceUrl: https://learn.microsoft.com/en-us/aspnet/core/fundamentals/servers/yarp/transforms-response
lastUpdated: 2026-08-11
---

## Response and Response Trailers {#response-and-response-trailers}
...
## ResponseHeadersCopy {#responseheaderscopy}
...
## Adds or replaces response headers {#adds-or-replaces-response-headers}
...
## Removes response headers {#removes-response-headers}
...
## ResponseHeadersAllowed {#responseheadersallowed}
...
## ResponseTrailersCopy {#responsetrailerscopy}
...
## Adds or replaces trailing response headers {#adds-or-replaces-trailing-response-headers}
...
## ResponseTrailerRemove {#responsetrailerremove}

## Removes trailing response headers {#removes-trailing-response-headers}
...
## ResponseTrailersAllowed {#responsetrailersallowed}
