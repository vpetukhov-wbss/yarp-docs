...
import { SearchDialog } from '../../features/search/components/search-dialog/search-dialog';
import { OfflineScreen } from '../offline-screen/offline-screen';
import { SiteHeader } from '../site-header/site-header';

@Component({
  selector: 'app-shell',
  imports: [SiteHeader, RouterOutlet, OfflineScreen, SearchDialog, TranslatePipe],
